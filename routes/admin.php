...
use App\Http\Middleware\Admin\isPurchased;
...
Route::group(['middleware' => 'auth.very_basic'], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin', 'namespace' => 'Admin'], function () {
        ...
        /////////////////////////
        /// 基本設定
        Route::middleware(isPurchased::class)->group(function () {
        ...
        Route::group(['prefix' => 'purchase'], function () {
            // Route::get('failed', [StripeController::class, 'failed'])->name('admin.purchase.failed');
            Route::match(['get', 'post'], '{id}/cancel', [StripeController::class, 'cancel'])->name('admin.purchase.cancel');
            Route::match(['get', 'post'], '{product_id}/change', [StripeController::class, 'change'])->name('admin.purchase.change');
            Route::post('{product_id}/resume', [StripeController::class, 'resume'])->name('admin.purchase.resume');
            Route::post('{product_id}/store', [StripeController::class, 'store'])->name('admin.purchase.store');
            Route::get('{product_id}/succeeded', [StripeController::class, 'succeeded'])->name('admin.purchase.succeeded');
            Route::get('{product_id}/failed', [StripeController::class, 'failed'])->name('admin.purchase.failed');
            Route::get('{product_id}', [StripeController::class, 'show'])->name('admin.purchase.show');
        });
        ...
        Route::middleware(isPurchased::class)->group(function () {
            ...
            Route::post('trainer/destroy', [TrainerController::class, 'destroy'])->name('admin.trainer.destroy');
            Route::post('trainer/change', [TrainerController::class, 'changePlan'])->name('admin.trainer.changePlan');
        });
        ////////////////////////////////////
        // 予約
        Route::middleware(isPurchased::class)->group(function () {
        ...
        Route::group(['prefix' => 'pay'], function () {
            Route::get('/', [PayController::class, 'index'])->name('admin.pay');
            Route::get('/create', [PayController::class, 'create'])->name('admin.pay.create');
            Route::post('/store', [PayController::class, 'store'])->name('admin.pay.store');
            Route::get('/{id}/edit', [PayController::class, 'edit'])->name('admin.pay.edit');
            Route::post('/{id}/update', [PayController::class, 'update'])->name('admin.pay.update');
        });
    });
});
