...
@section('content')
    <div class="container-fluid">
        {{ Breadcrumbs::render('admin.product.show', $product) }}
        <div class="row">
            <div class="col-4">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th scope="row" colspan="2"><a href="{{ route('admin.product.edit', $product->id) }}">編集</a></th>
                    </tr>
                    </tbody>
                </table>
                <br>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                {!! Form::open(['route' => ['admin.product.destroy', $product->code], 'method' => 'delete']) !!}
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                {!! Form::open(['route' => ['admin.product.copy', $product->id], 'method' => 'post']) !!}
