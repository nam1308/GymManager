    ...
    @if($trainer)
      ...
      <form id="reservationForm" method="post" action="{{ route('channel.trainer.reservation.store', [$vendor_id, $trainer_id]) }}">
        ...
        <div class="form-group">
          ...
          <small id="emailHelp" class="form-text text-muted">予約申請を選択してください</small>
        </div>
        <div class="form-group">
          <label>時間</label>
        ...
        <button type="submit" class="btn btn-primary btn-block btn-lg" id="submitButton">予約申請する</button>
      </form>
    @else
