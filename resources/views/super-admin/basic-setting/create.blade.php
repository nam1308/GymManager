...
@section('content')
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card">
          <div class="card-header">{{ __('お申込み') }}</div>
          <div class="card-body">
            <form method="POST" action="{{ route('super-admin.basic-setting.store') }}" class="h-adr">
              <span class="p-country-name" style="display:none;">Japan</span>
              @csrf
              <div class="form-group row">
                <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('お名前') }}</label>
                <div class="col-md-7">
                  <input placeholder="" id="postal_code"
              ...
              <div class="form-group row mb-0">
                <div class="col-md-7 offset-md-3">
                  <button type="submit" class="btn btn-primary btn-block btn-lg"> {{ __('申込む') }} </button>
                </div>
              </div>
            </form>
          </div>
