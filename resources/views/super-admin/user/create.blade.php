...
@section('content')
  ...
  <div class="container-fluid">
    {{ Breadcrumbs::render('super-admin.user.create') }}
    <div class="container">
      <div class="col">
        <div class="card">
          <div class="card-header">{{ __('会員登録') }}</div>
          <div class="card-body">
            {{ Form::open(['url' => route('super-admin.user.store'), 'class' => 'h-adr']) }}
